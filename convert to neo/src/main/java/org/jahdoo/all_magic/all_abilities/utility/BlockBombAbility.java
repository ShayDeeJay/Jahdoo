...
public class BlockBombAbility extends AbstractAbility {
    ...
    public void invokeAbility(Player player) {
        GenericProjectile genericProjectile = new GenericProjectile(player, 0.06, ProjectilePropertyRegister.BLOCK_EXPLODER.get().setAbilityId());
        fireProjectile(genericProjectile, player, 0.8f);
    }
