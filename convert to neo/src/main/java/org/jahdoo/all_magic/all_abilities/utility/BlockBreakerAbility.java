...
public class BlockBreakerAbility extends AbstractAbility {
    private final ResourceLocation abilityId = GeneralHelpers.modResourceLocation("block_breaker");

    @Override
    public void invokeAbility(Player player) {
        GenericProjectile genericProjectile = new GenericProjectile(player, 0.06, ProjectilePropertyRegister.BLOCK_BREAKER.get().setAbilityId());
