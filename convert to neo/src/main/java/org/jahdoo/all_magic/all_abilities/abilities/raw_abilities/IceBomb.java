...
//        return new TagModifierHelper(this.elementProjectile.getCompoundTag(), IceBombAbility.abilityId.getPath().intern());
        System.out.println(this.elementProjectile.wandAbilityHolder());
        return new TagModifierHelper(this.elementProjectile.wandAbilityHolder(), IceBombAbility.abilityId.getPath().intern());
    }
    ...
    private void setCollisionParticle(){
        if(this.elementProjectile.level() instanceof ServerLevel serverLevel){
            ParticleOptions particleOptions = genericParticleOptions(
                MAGIC_PARTICLE_SELECTION, 10, 0.5f,
