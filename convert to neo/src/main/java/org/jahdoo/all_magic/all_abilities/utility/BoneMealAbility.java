...
public class BoneMealAbility extends AbstractAbility {
    private final ResourceLocation abilityId = GeneralHelpers.modResourceLocation("bone_meal");

    @Override
    public void invokeAbility(Player player) {
        GenericProjectile genericProjectile = new GenericProjectile(player, 0.06, ProjectilePropertyRegister.BONE_MEAL.get().setAbilityId());
