...
public class Boltz extends DefaultEntityBehaviour {
    ...
    public void getElementProjectile(ElementProjectile elementProjectile) {
        ...
        this.dischargeRadius = this.getTag().getModifierValue(BoltzAbility.dischargeRadius);
        if(this.elementProjectile.getOwner() != null){
            this.damage = DamageCalculator.getCalculatedDamage((LivingEntity) this.elementProjectile.getOwner(), this.getTag().getModifierValue(DAMAGE));
        }
    }
    ...
    public TagModifierHelper getTag() {
        return new TagModifierHelper(this.elementProjectile.wandAbilityHolder(), BoltzAbility.abilityId.getPath().intern());
    }
    ...
    public void onEntityHit(LivingEntity hitEntity) {
        ...
        hitEntity.hurt(owner != null ? owner.damageSources().magic() :  this.elementProjectile.damageSources().magic(), GeneralHelpers.getMagicDamageAmplifier(owner, (float) damage, this.getElementType()));
    ...
    void orbEnergyParticles(Projectile projectile, double numberOfPoints, double radius){
        ...
        GenericParticleOptions particleOptions = genericParticleOptions(ParticleStore.ELECTRIC_PARTICLE_SELECTION, this.getElementType(), GeneralHelpers.Random.nextInt(2,8), 1f, 0.3);
            ...
            livingEntity -> {
                if (!(livingEntity instanceof Player)) {
                    ...
                    livingEntity.hurt(
                        ...
                        GeneralHelpers.getMagicDamageAmplifier((LivingEntity) this.elementProjectile.getOwner(), (float) damage, this.getElementType())
                    );
                }
            }
        );
