...
public class SharedUI {
    ...
    public static void getAbilityNameWithColour(
        ...
        if (abstractAbility.isMultiType()) {
            String abilityName = abstractAbility.getAbilityResource().getPath().intern();
            String tagName = "Element Type";
            List<AbstractElement> abstractElement = ElementRegistry.getElementByTypeId(compoundTag.getCompound(abilityName).getInt(tagName));
    ...
    public static int getAbilityNameWithColour(
        AbstractAbility abstractAbility,
        ItemStack itemStack
    ){
        int element;
