...
public class WizardClothingLayerRenderer<T extends Mob & RangedAttackMob, M extends EntityModel<T>> extends RenderLayer<T, M> {
    private static final ResourceLocation STRAY_CLOTHES_LOCATION = GeneralHelpers.modResourceLocation("textures/entity/eternal_wizard/eternal_wizard_outer_top_1.png");
