...
public class AoeCloud extends Entity implements TraceableEntity {
    ...
    public AoeCloud(Level pLevel, LivingEntity livingEntity, float setWidth, String selectedAbility)  {
    ...
    public AoeCloud(Level pLevel, LivingEntity livingEntity, float setWidth, String selectedAbility, WandAbilityHolder wandAbilityHolder)  {
        super(EntitiesRegister.CUSTOM_AOE_CLOUD.get(), pLevel);
        this.reapplyPosition();
        this.setRadius(setWidth);
        this.owner = livingEntity;
...
//        pCompound.put("compound_tag", (Tag) this.wandAbilityHolder);
...
//        this.wandAbilityHolder = (DataComponentMap) pCompound.getCompound("compound_tag");
