...
public class FollowGoal extends Goal {
    private final EternalWizard tamable;
    ...
    public FollowGoal(EternalWizard pTamable, double pSpeedModifier, float pStartDistance, float pStopDistance, boolean pCanFly) {
