package org.jahdoo.items.heart_container;
...
public class HealthContainer extends Item implements ItemEntityBehaviour {
    ...
    public boolean onItemInteraction(ItemEntity itemEntity, LivingEntity livingEntity) {
        if(livingEntity.level() instanceof ServerLevel serverLevel){
            GeneralHelpers.getSoundWithPosition(serverLevel, itemEntity.blockPosition(), SoundEvents.ILLUSIONER_PREPARE_MIRROR,1,1f);
